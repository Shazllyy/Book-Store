...
namespace lab7.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Publish_on,Publisher,Price,Authors,ImageURL,Tages")] Book book, int[] Authors, int[] Tags)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Publish_on,Publisher,Price,ImageURL")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
